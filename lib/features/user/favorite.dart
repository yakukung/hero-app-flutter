...
class _FavoritePageState extends State<FavoritePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _sheetsController.fetchFavorites(showLoading: true);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        final favoriteSheets = _sheetsController.favoriteSheets.toList();
        final isLoading =
            _sheetsController.isLoading.value && favoriteSheets.isEmpty;
        ...
        return SafeArea(
          child: CustomScrollView(
            slivers: [
              ...
              else if (favoriteSheets.isEmpty)
                SliverFillRemaining(
                  child: Center(
                    child: Column(
                        ...
                        child: ProductCard(
                          ...
                          onFavoriteTap: () {
                            showCustomDialog(
                              ...
                              isConfirm: true,
                              onOk: () async {
                                final success = await _sheetsController
                                    .removeFavorite(sheet.id);
                                if (!context.mounted || !success) return;
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: const Text('ลบจากรายการโปรดแล้ว'),
