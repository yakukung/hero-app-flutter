...
import 'package:flutter_application_1/shared/widgets/upload/question_section.dart';
import 'package:flutter_application_1/shared/widgets/upload/subject_selector.dart';
...
class _UploadPageState extends State<UploadPage> {
  ...
  void _showValidationError(ValidationError error) {
    showCustomDialog(title: error.title, message: error.message);
  }

  Future<void> _uploadSheet() async {
    final validationError = validateSheetUpload(
